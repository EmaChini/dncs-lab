...
Remember that if the VM have been already created it is mandatory to use the instruction `vagrant provision --provision` otherwise the Vagrantfile will not load the .sh file.
